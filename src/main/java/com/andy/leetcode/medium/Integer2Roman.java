...
public class Integer2Roman {
     ...
     *
     * @seehttps://leetcode.com/problems/integer-to-roman/
     */
    private static int[] val = new int[]{1000, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1};

    private static String[] str = new String[]{"M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"};
    ...
    public static void main(String[] args) {
        System.out.println(new Integer2Roman().intToRoman(3));
        System.out.println(new Integer2Roman().intToRoman(4));
        System.out.println(new Integer2Roman().intToRoman(9));
        System.out.println(new Integer2Roman().intToRoman(58));
